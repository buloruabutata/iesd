    ...
    for epoch in range(EPOCH):
        ...
        for step, (x, y) in enumerate(trainloader):
            with tf.GradientTape() as tape:
                ...
                running_loss += loss
                i += 1
        test_log = '[Epoch, Batches] is [%d, %5d] \nTrain Acc: %.5f Train loss: %.5f' % (epoch + 1, i, accuracy / i, running_loss / i)
        print(test_log)
        yy_log.write(test_log)
        ...
        acc_log = 'Test Acc: %.5f Test Loss: %.5f' % (correct / total, running_loss_test / i)
        print(acc_log)
        yy_log.write(acc_log)
        net.save(f'./saved_models/ECG_net_tf{correct / total}.h5')
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--path_data', type=str, default='/home/user/training_dataset/')
    argparser.add_argument('--path_indices', type=str, default='./data_indices/')
    argparser.add_argument('--name', type=str, default='./1.txt')
